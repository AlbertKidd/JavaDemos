...
public class ActiveMQDemo {
    ...
    public static final String CONN_OPEN_WIRE = "tcp://localhost:62626";
    public static final String USERNAME = "admin";
    public static final String PASSWORD = "yidakeji";
    ...
    private static Destination connect(String connURL, DestType destType, String destName) throws Exception{
        ...
        factory = new ActiveMQConnectionFactory(USERNAME, PASSWORD, connURL);
...
//        MessageConsumer consumer = session.createConsumer(dest);
        MessageConsumer consumer = session.createDurableSubscriber((Topic) dest, "KiddSubscriber");
